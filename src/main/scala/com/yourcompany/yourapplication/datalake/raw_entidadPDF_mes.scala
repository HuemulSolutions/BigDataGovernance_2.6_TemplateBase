...
class raw_entidadPDF_mes(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   ...
   CurrentSetting.FileType = huemulType_FileType.PDF_FILE
   ...
   //Forma detallada
   CurrentSetting.DataSchemaConf.AddColumns("Codigo", "Codigo", StringType, "Codigo de la tabla")
   CurrentSetting.DataSchemaConf.AddColumns("Grupo", "Grupo", StringType, "Grupo")
